...
use apps\common\service\AskSeoService;
use think\View;

class Seo extends Ask {
	...
	public function __construct() {
		...
		$this->service = AskSeoService::instance();
	}
	...
	public function index() {
		...
		//uri
		$this->_addParam( 'uri', [
			'upload'       => full_uri( 'ask/seo/upload' ),
'albumCatalog' => full_uri( 'ask/seo/read_album_catalog' ),
'album'        => full_uri( 'ask/seo/read_album' ),
