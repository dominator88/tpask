...
use apps\common\service\AskRegisterService;
use think\View;

class Register extends Ask {
	...
	public function __construct() {
		...
		$this->service = AskRegisterService::instance();
	}
	...
	public function index() {
		...
		//uri
		$this->_addParam( 'uri', [
			'upload'       => full_uri( 'ask/register/upload' ),
'albumCatalog' => full_uri( 'ask/register/read_album_catalog' ),
'album'        => full_uri( 'ask/register/read_album' ),
