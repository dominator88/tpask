...
class Email extends Ask {
	...
	public function __construct() {
		...
		$this->service = AskEmailService::instance();
	}
	...
	public function index() {
		...
		//uri
		$this->_addParam( 'uri', [
			'upload'       => full_uri( 'ask/email/upload' ),
'albumCatalog' => full_uri( 'ask/email/read_album_catalog' ),
'album'        => full_uri( 'ask/email/read_album' ),
