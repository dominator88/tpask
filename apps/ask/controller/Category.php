...
class Category extends Ask {
	
	/**
	 * AskCategory constructor.
	 */
	public function __construct() {
		parent::__construct();
		$this->_initClassName( __CLASS__ );
		$this->service = AskCategoryService::instance();
	}
	...
	public function index() {
		...
		//uri
		$this->_addParam( 'uri', [
			'menu'         => '/ask/category/index',
			'upload'       => full_uri( 'ask/Category/upload' ),
			'albumCatalog' => full_uri( 'ask/Category/read_album_catalog' ),
			'album'        => full_uri( 'ask/Category/read_album' ),
		] );
