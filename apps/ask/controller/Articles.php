...
use apps\common\service\AskArticlesTagsService;
use apps\common\service\MerUserCommentsService;

class Articles extends Ask {
  ...
  public function __construct() {
    ...
    $this->service = AskArticlesService::instance();
  }
  ...
  public function index() {
    ...
    $this->_addParam( 'uri' , [
      ...
      'readComment'  => full_uri( 'ask/Articles/read_comment' ) ,
      'setComment'   => full_uri( 'ask/Articles/set_comment' ) ,
      'albumCatalog' => full_uri( 'ask/Articles/read_album_catalog' ) ,
      'album'        => full_uri( 'ask/Articles/read_album' ) ,
      'upload'       => full_uri( 'ask/Articles/upload' ) ,
    ...
    //其他参数
    $ArticlesCatalog = AskCategoryService::instance();
    ...
    $this->_addParam( [
      ...
      'catalog'       => $ArticlesCatalog->getByCond( [
  ...
  public function insert() {
    ...
    if ( $result['code'] == 0 ) {
      $ArticlesTags = AskArticlesTagsService::instance();
      $ArticlesTags->addArticleTags(  $result['data']['id'] , $data['tags'] );
    }
  ...
  public function update() {
    ...
    if ( $result['code'] == 0 ) {
      $ArticlesTags = AskArticlesTagsService::instance();
      $ArticlesTags->addArticleTags( $id , $data['tags'] );
    }
