...
class AskQuestionsTagsService extends BaseService {
  ...
  public static function instance() {
    if ( self::$instance == NULL ) {
      self::$instance        = new AskQuestionsTagsService();
      self::$instance->model = db( 'AskQuestionsTags' );
    }
