...
class MerArticlesService extends BaseService {
  ...
  public static function instance() {
    if ( self::$instance == NULL ) {
      self::$instance        = new MerArticlesService();
      self::$instance->model = db( 'MerArticles' );
    }
  ...
  function getByCond( $param ) {
    ...
    $this->model->join( 'mer_articles_catalog ac' , 'ac.id = a.catalog_id' );
...
//		echo $this->model->getLastSql();
   ...
   * @return array
   */
  public function getByIdWithMerAndUser( $id , $merId , $userId = '' ) {
    $this->model
      ->alias( 'a' )
      ->where( 'a.id' , $id )
