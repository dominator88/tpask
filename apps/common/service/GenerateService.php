...
define( 'SYSTEM_TEMP_BASE_PATH', APP_PATH . '/common/generate/system/' );
define( 'API_TEMP_BASE_PATH', APP_PATH . '/common/generate/api' );
...
class GenerateService {
	...
	//文件存储路径 		ucfirst()
	var $filePath = [
		'model'      => APP_PATH . 'common/model/{func}.php',
		'service'    => APP_PATH . 'common/Service/{func}Service.php',
	...
	public function getTables() {
		$data = db( 'information_schema.tables' )
			->field( 'table_name as tableName' )
	...
	private function getTableField( $tableName ) {
		...
		$db = db( 'information_schema.columns' );
		...
		$db->where( 'TABLE_SCHEMA', config( 'database.database' ) );
