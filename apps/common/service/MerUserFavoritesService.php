...
class MerUserFavoritesService extends BaseService {
	...
	public static function instance() {
		if ( self::$instance == NULL ) {
			self::$instance        = new MerUserFavoritesService();
			self::$instance->model = db( 'MerUserFavorites' );
		}
