...
class MerUserCommentsService extends BaseService {
  ...
  public static function instance() {
    if ( self::$instance == NULL ) {
      self::$instance        = new MerUserCommentsService();
      self::$instance->model = db( 'MerUserComments' );
    }
  ...
  function getByCond( $param ) {
    ...
    $this->model
      ->field( $param['field'] )
      ->join( 'mer_user u' , 'u.id = c.user_id' , 'left' );
