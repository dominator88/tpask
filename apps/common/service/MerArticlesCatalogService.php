...
class MerArticlesCatalogService extends BaseService {
	...
	public static function instance() {
		if ( self::$instance == NULL ) {
			self::$instance        = new MerArticlesCatalogService();
			self::$instance->model = db( 'MerArticlesCatalog' );
		}
